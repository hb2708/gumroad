    ...
    >
      <form>
        <section className="grid gap-8 p-4 md:p-8 lg:grid-cols-[25%_1fr] lg:gap-x-16 lg:pb-16">
          <header className="space-y-3 lg:row-[1/4]">
              ...
              <TableBody>
                <TableRow>
                  <TableCell>
                    <Toggle
                      id="all-products-cut"
                      value={form.data.apply_to_all_products}
                      onChange={(enabled) => {
                  ...
                  <TableCell>
                    <label htmlFor="all-products-cut" className="cursor-pointer">
                      All products
                    </label>
                  </TableCell>
                  <TableCell>
                      ...
                      >
                        {(inputProps) => (
                          <Input
                            ...
                            aria-invalid={!!form.errors.percent_commission}
                            {...inputProps}
                          />
                        )}
                      </NumberInput>
                  ...
                  <TableCell>
                    <label
                      className={classNames(
                        ...
                        !form.data.apply_to_all_products && "cursor-not-allowed opacity-35",
                      )}
                    >
                      <Checkbox
                ...
                {form.data.products.map((product, index) => {
                  ...
                  return shouldShowProduct(product) ? (
                    <TableRow key={product.id}>
                      ...
                      <TableCell>
                        <label className="inline-flex cursor-pointer gap-2">{product.name}</label>
                          ...
                          >
                            {(inputProps) => (
                              <Input
                                ...
                                aria-label="Percentage"
                                trailing={<Pill className="-mr-2 shrink-0">%</Pill>}
                                aria-invalid={!!form.errors[`products.${index}.percent_commission`]}
                                {...inputProps}
                              />
                            )}
                          </NumberInput>
